...
export const metadata = {
  title: "Stocks | Data Centre",
};

export default function StocksPage() {
  const stockConfig = masterDataConfig.stock;

  if (!stockConfig) {
    return <div>Configuration for Stocks not found.</div>;
  }
  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200">
        <DynamicMasterTable modelConfig={stockConfig} />
      </div>
    </div>
  );
}
