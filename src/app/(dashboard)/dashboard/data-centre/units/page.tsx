...
export const metadata = {
  title: "Units | Data Centre",
};

export default function UnitsPage() {
  const unitsConfig = masterDataConfig.unitOfMeasurement;

  if (!unitsConfig) {
    return <div>Configuration for Units not found.</div>;
  }
  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200">
        <DynamicMasterTable modelConfig={unitsConfig} />
      </div>
    </div>
  );
}
