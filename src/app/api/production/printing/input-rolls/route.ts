...
/** Available loom/laminated rolls that can be fed into printing. */
export async function GET(request: NextRequest) {
  ...
  const where: Prisma.ProductionRollWhereInput = {
    consumedAt: null,
    sourcePhase: { in: ["LOOM", "LAMINATION"] },
    printingRunsAsInput: {
      none: { productionRun: { endedAt: null } },
    },
  };
  ...
  try {
    ...
    console.error("Error fetching printing input rolls:", error);
